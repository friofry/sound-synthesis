...
INPUT_PITCH="${SCRIPT_DIR}/pitch_analysis.c"
INPUT_PITCH_SIMD="${SCRIPT_DIR}/pitch_analysis_simd.c"
OUTPUT_WASM_PITCH="${SCRIPT_DIR}/pitch_analysis.wasm"
OUTPUT_BASE64_TS_PITCH="${SCRIPT_DIR}/pitch_analysis.wasm.base64.ts"
OUTPUT_WASM_PITCH_SIMD="${SCRIPT_DIR}/pitch_analysis_simd.wasm"
OUTPUT_BASE64_TS_PITCH_SIMD="${SCRIPT_DIR}/pitch_analysis_simd.wasm.base64.ts"
...
build_pitch_wasm() {
  ...
  -nostdlib \
  -Wl,--no-entry \
  -Wl,--export=find_dominant_decibels \
  -Wl,--export=find_dominant_linear_mag \
  -Wl,--export=find_dominant_spectrum_points \
  -Wl,--export=pick_loudest_frame_f64 \
  -Wl,--export-memory \
...
build_pitch_wasm "${INPUT_PITCH}" "${OUTPUT_WASM_PITCH}" "${OUTPUT_BASE64_TS_PITCH}" "PITCH_ANALYSIS_WASM_BASE64"
build_pitch_wasm_simd "${INPUT_PITCH_SIMD}" "${OUTPUT_WASM_PITCH_SIMD}" "${OUTPUT_BASE64_TS_PITCH_SIMD}" "PITCH_ANALYSIS_SIMD_WASM_BASE64"
